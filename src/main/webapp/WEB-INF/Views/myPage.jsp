...
<div class="my-page-container">
    ...
    <div class="my-page-content">
        ...
        <div class="my-page-solved">
            ...
            <div class="solved-box">
                <c:forEach items="${solvedProblems}" var="problem">
                    <a href="/problemSolvedLog?problemId=${problem.problemId}">
        ...
        <div class="my-page-solved">
            <div class="solved-title">틀린 문제</div>
            <div class="not-solved-box">
                <c:forEach items="${notSolvedProblems}" var="notSolvedProblem">
                    <a href="/problemSolvedLog?problemId=${notSolvedProblem.problemId}">
                        <div>${notSolvedProblem.problemId.toString()}</div>
                    </a>
                </c:forEach>
            </div>
        </div>
